...
public class DailyReportSender extends Sender {
    ...
    private final String INTRO_INFO_DR = """
            ...
            *__"питомец: Барбос__*
            *__Самочувствие хорошее. Настроение спокойное. Дневной рацион: сухой корм,__*
            *__влажный корм - раз в сутки. Из новых привычек - привыкает к лежанке"__*
    ...
    private String[] parsePetNameAndDailyText(String caption){
        String[] parseResult = {"", ""};
        Matcher m1 = Pattern.compile("[Пп]итомец:\\s*([а-яА-ЯйЙ\\w]+?)\\s*$",
